    ...
    return function t(e, r, i) {
        ...
        2: [function(t, e) {
            !function() {
                ...
                c = function(t, e, i) {
                    ...
                    b = [],
                    a = f = 0,
                    y = l(e, t.length); y >= 0 ? y > f : f > y; a = y >= 0 ? ++f : --f)
                        b.push(o(t, i));
                    return b
                }
                ,
        ...
        3: [function(t, e) {
            ...
            r.prototype.getNeighbors = function(t, e, r) {
                var i = t.x
                  ...
                  , f = !1
                  , d = this.nodes;
                return this.isWalkableAt(i, n - 1) && (o.push(d[n - 1][i]),
                s = !0),
            ...
            r.prototype.clone = function() {
                var t, e, n = this.width, o = this.height, s = this.nodes, a = new r(n,o), u = [];
                for (t = 0; o > t; ++t)
                    for (u[t] = [],
                    e = 0; n > e; ++e)
        ...
        7: [function(t, e) {
            ...
            r.prototype.findPath = function(t, e, r, o, s) {
                ...
                ), y = s.getNodeAt(t, e), b = s.getNodeAt(r, o), A = this.heuristic, k = this.allowDiagonal, m = this.dontCrossCorners, v = this.weight, w = Math.abs, x = Math.SQRT2;
                for (y.g = 0,
                y.f = 0,
                g.push(y),
                y.opened = !0; !g.empty(); ) {
        ...
        9: [function(t, e) {
            ...
            r.prototype.findPath = function(t, e, r, o, s) {
                var a, u, h, l, p, c, f, d, g = function(t, e) {
                    return t.f - e.f
                }, y = new i(g), b = new i(g), A = s.getNodeAt(t, e), k = s.getNodeAt(r, o), m = this.heuristic, v = this.allowDiagonal, w = this.dontCrossCorners, x = this.weight, F = Math.abs, W = Math.SQRT2, N = 1, C = 2;
                for (A.g = 0,
                A.f = 0,
                y.push(A),
                A.opened = N,
                ...
                k.opened = C; !y.empty() && !b.empty(); ) {
                    ...
                    p = u.length; p > l; ++l)
                        ...
                        !h.closed) {
                            ...
                            h.f = h.g + h.h,
                            h.parent = a,
                            h.opened ? y.updateItem(h) : (y.push(h),
                            h.opened = N))
                        }
                    for (a = b.pop(),
                    a.closed = !0,
        ...
        13: [function(t, e) {
            ...
            r.prototype.findPath = function(t, e, r, n, o) {
                ...
                d.opened = !0; p.length; ) {
                    ...
                    for (s = o.getNeighbors(u, c, f),
                    h = 0,
                    l = s.length; l > h; ++h)
                        a = s[h],
                        a.closed || a.opened || (p.push(a),
                        a.opened = !0,
                        a.parent = u)
                }
                return []
        ...
        15: [function(t, e) {
            ...
            r.prototype.findPath = function(t, e, r, i, o) {
                ...
                .bind(this), c = function(t, e) {
                    ...
                    if (h++,
                    this.timeLimit > 0 && (new Date).getTime() - l > 1e3 * this.timeLimit)
                        return 1 / 0;
                    ...
                    for (y = 0,
                    u = 1 / 0; b = A[y]; ++y) {
                        if (this.trackRecursion && (b.retainCount = b.retainCount + 1 || 1,
        ...
        16: [function(t, e) {
            ...
            r.prototype._identifySuccessors = function(t) {
                ...
                for (Math.max,
                e = this._findNeighbors(t),
                n = 0,
                s = e.length; s > n; ++n)
                    if (r = e[n],
                    i = this._jump(r[0], r[1], b, A)) {
                        if (a = i[0],
                        u = i[1],
                        p = c.getNodeAt(a, u),
                        p.closed)
            ...
            r.prototype._findNeighbors = function(t) {
                ...
                if (h)
                    ...
                    0 !== i && 0 !== n ? (c.isWalkableAt(l, p + n) && f.push([l, p + n]),
                    ...
                    !c.isWalkableAt(l, p - n) && c.isWalkableAt(l + i, p) && f.push([l + i, p - n])) : 0 === i ? c.isWalkableAt(l, p + n) && (f.push([l, p + n]),
                    c.isWalkableAt(l + 1, p) || f.push([l + 1, p + n]),
                    c.isWalkableAt(l - 1, p) || f.push([l - 1, p + n])) : c.isWalkableAt(l + i, p) && (f.push([l + i, p]),
                    c.isWalkableAt(l, p + 1) || f.push([l + i, p + 1]),
                    c.isWalkableAt(l, p - 1) || f.push([l + i, p - 1]));
                else
                    for (o = c.getNeighbors(t, !0),
                    a = 0,
                    u = o.length; u > a; ++a)
                        s = o[a],
                        f.push([s.x, s.y]);
        ...
        17: [function(t, e) {
            ...
            r.prototype._findNeighbors = function(t) {
                ...
                if (h)
                    ...
                    i = (l - e) / Math.max(Math.abs(l - e), 1),
                    n = (p - r) / Math.max(Math.abs(p - r), 1),
                    0 !== i ? (c.isWalkableAt(l, p - 1) && f.push([l, p - 1]),
                    c.isWalkableAt(l, p + 1) && f.push([l, p + 1]),
                    c.isWalkableAt(l + i, p) && f.push([l + i, p])) : 0 !== n && (c.isWalkableAt(l - 1, p) && f.push([l - 1, p]),
                    c.isWalkableAt(l + 1, p) && f.push([l + 1, p]),
                    c.isWalkableAt(l, p + n) && f.push([l, p + n]));
                else
                    for (o = c.getNeighbors(t, !1),
                    a = 0,
                    u = o.length; u > a; ++a)
                        s = o[a],
                        f.push([s.x, s.y]);
